...
//  ScanKit
//
//  Created by Basem Emara -> https://zamzam.io/creating-thread-safe-arrays-in-swift/
//
...
public class ThreadSafeArray<Element> {
    fileprivate let queue = DispatchQueue(label: "io.zamzam.ZamzamKit.ThreadSafeArray", attributes: .concurrent)
